# Marozia and the Pornocracy — the Christian arc's X-Files peak

The **House of Theophylact** ran the papacy from roughly 900 to 960 CE.
Marozia (c. 890 – c. 937) is the central figure: mistress of one pope,
mother of another, grandmother of a third, senatrix of Rome. This is
the X-Files peak of the Christianity arc (see
`../gaiad-tone-and-founders.md` §3) — *not* the founding.

## The setup

- **Theodora the Elder** and her daughters **Marozia** and **Theodora
  the Younger** effectively control Rome, and with it the papacy,
  across two or three generations.
- **Pope Sergius III** — Marozia's lover; father of her son, the future
  **Pope John XI**.
- **Pope John XI** — Marozia's son; placed on the throne by her.
- **Pope John XII** — her grandson via her son Alberic II. Notorious
  for his conduct even by Dark Age standards.
- Marozia herself crowned **Alberic II of Spoleto**'s regime over Rome;
  married **Hugh of Italy** and was deposed by her own son.

## Why the Gaiad treats it as the peak

- **Weird-systematic, not comedic** (see
  `../gaiad-tone-and-founders.md` §1). This is the tone principle in
  its purest form: a dense cluster of institutionally-improbable-but-
  real relationships, assembled without editorial smoothing, producing
  the X-Files effect.
- **Not the founding.** The deflationary work on Christianity in the
  Gaiad does not hit the founding; it hits the institution at its
  darkest comedy. Pro-Jesus in net (`jesus.md`), deflationary on the
  institutional arc here.
- **Genealogical fact.** Several actual popes really were blood
...
- Chapter anchors in Marozia as a *person*, not as a moral lesson
  about corruption. She is a competent political operator in a system
  her family built; the chapter honors that.
- Papal material sits in Register C proper. Post-BAC register, well
  into medieval historiography, no register-shift pyrotechnics needed.
- Connects loosely to `elagabalus.md` (another "emperor does something
  institutionally deranged in Rome" chapter, three centuries earlier,
  different X-Files beat).
