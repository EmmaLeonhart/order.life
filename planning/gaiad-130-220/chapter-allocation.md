# Chapter Allocation — Running List

**Total budget:** 91 chapters (ch 130–220)

This is the master allocation list. As chapters get assigned,
they go here. Unallocated chapters remain available for the
remaining material (biblical arc, Hindu epics, religious founders,
mythic cycles, Greece/Rome, Islamic arc, etc.).

## Haplogroup chapters (14 chapters)

Per `haplogroups.md` draft proposal. Follow the Y-chromosome tree
branching with civilizations and language families woven in.

| # | Chapter | Haplogroup | Key content |
|---|---------|-----------|-------------|
| 1 | Adam / Y-chromosomal origin | A, A00, A0-T | Genesis opening, A/B stay in Africa |
| 2 | Cain / Abel / Seth | A vs. BT divergence | Biblical overlay on earliest splits |
| 3 | Noah / out of Africa | CT | Somalia → Bab al-Mandab → Yemen |
| 4 | DE split / D and Toba | DE → D | Toba catastrophe, Japan/Tibet/Andaman refugia |
| 5 | CF split / C unsplit | CF → C | Indigenous Australia + Central Asian steppe |
| 6 | IJ split / I old Europe | I | Pre-IE hunter-gatherers, Cucuteni-Trypillia |
| 7 | G builds the Neolithic | G | Göbekli Tepe, agriculture, architecture |
| 8 | J the Semitic world | J (J1, J2) | Semitic languages, Afroasiatic, ancient Near East |
| 9 | H, L, T / Indus Valley | H, L, T | Illegible civilization, Dravidian/Elamite |
| 10 | N the Uralic peoples | N | Finnish, Hungarian, Sami; linguistic survival |
| 11 | O rice agriculture | O | East Asia, Sino-Tibetan, Austronesian, Austro-Asiatic |
| 12 | P at Baikal | P | "Paikal", QR divergence point |
| 13 | Manu and Yemo / Yamnaya | R (R1a, R1b) | PIE founding pair, Yamnaya expansion |
| 14 | E returns to Africa | E | Loop-closer, Afroasiatic spread |

## Sequenced chapters (post-haplogroup)

| # | Chapter | Key content |
|---|---------|-------------|
| 15 | Malta | Megalithic temples (~3600–2500 BCE). Oldest freestanding stone structures on earth. |
| 16 | Old Kingdom | Pyramid age. Khufu, Khafre, Menkaure. Giza. First Dynasty of Kish mentioned, Gutians noted alongside collapse. |
| 17 | Akkadian Empire | Sargon of Akkad. First empire. Falls to Gutians (noted in Old Kingdom chapter from Egyptian side). |
| 18 | Stonehenge | Megalithic Britain. |
| 19 | Minoan | Crete, palace civilization, Linear A (undeciphered), Thera eruption. |
| 20 | Yamnaya | Indo-European expansion from the steppe (~3000 BCE). See `manu-yemo.md`, `cucuteni-trypillia.md`. |
| 21 | Yellow Emperor | Huangdi. Chinese civilizational origin. Three Sovereigns and Five Emperors. |
| 22 | Neo-Sumerian Empire + Abraham | Ur III dynasty. Abraham lives in it. It falls to Elam. Abraham flees first to Sanliurfa where he meets Melchizedek (George Gobeklius — Göbekli Tepe connection), then goes down to Judea. |
...
Per `mongol-block.md`. Eight-day arc, Sunday to Sunday.
...
Per `late-medieval-sequence.md`. The acceleration zone.
