...
HUMAN_CLASSES = {
    ...
    "Q182406",      # Oceanid
    "Q3027575",     # Potamoi
    # Added 2026-07-30 after Emma confirmed these are correct records, not errors.
    # Every class below was observed on a not_a_human row whose local label matched
    # the Wikidata item at >=0.95 -- i.e. the id is demonstrably right and only the
    # instance-of type made it look wrong. This dump is a synoptic mythology, so
    # Titans, Giants, Cyclopes, nymphs, biblical figures and taxa all belong.
    # Emma also confirmed the taxon-typed records are Gaiad evolution-tier
    # characters where the character IS the lineage, so taxa are valid too.
    "Q191192",
    "Q124940323",
    "Q45713",
    "Q6949213",
