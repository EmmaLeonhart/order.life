...
**8 cycles, 80 records caught in one.** Generated from the dump by `wiki-scripts/build_cycles_notion.py`; the source of truth is `wikibase/analysis/cycles_review.md` in the repo and this page is a copy of it.
...
|---|---|---|---:|---:|---:|---:|---:|:---:|
| `Q72434` | Marcus Aemilius Lepidus | Q435329 | 120 BC | 77 BC | **896** | 28,681 | 255 | yes |
| `Q72615` | Quintus Aemilius Lepidus | Q11944252 | — | — | **896** | 28,681 | 255 | yes |
| `Q72786` | Marcus Aemilius Lepidus | — | — | — | **896** | 28,681 | 255 | yes |
| `Q72801` | Cornelia | Q100804879 | — | — | **896** | 28,681 | 255 | yes |
| `Q72957` | Consul (138 BC) - Publius Cornelius Scipio Nas | — | 182 BC | 132 BC | **896** | 28,681 | 255 | yes |
| `Q73128` | Publius Cornelius Scipio Nasica Corculum | Q503320 | 205 | 141 | **896** | 28,681 | 255 | yes |
| `Q73131` | Cornelia Africana Major | Q5171151 | 201 | — | **896** | 28,681 | 255 | yes |
| `Q73293` | Publius Cornelius Scipio Nasica | Q453860 | 230 | 171 | **896** | 28,681 | 255 | yes |
| `Q73299` | Scipio Africanus | Q2253 | 235 | 183 | **896** | 28,681 | 255 | yes |
| `Q73443` | Gnaeus Cornelius Scipio Calvus | Q316475 | 256 | 211 | **896** | 28,681 | 255 | yes |
| `Q73446` | Publius Cornelius Scipio | Q3293507 | 255 | 211 | **896** | 28,681 | 255 | yes |
| `Q73569` | Lucius Cornelius Scipio | Q708483 | 306 | 250 | **896** | 28,681 | 255 | yes |
| `Q73692` | Lucius Cornelius Scipio Barbatus | Q374630 | 400 | 300 | **896** | 28,681 | 255 | yes |
| `Q73794` | Gnaeus Cornelius Scipio | Q128598522 | — | — | **896** | 28,681 | 255 | yes |
| `Q73893` | Lucius Cornelius Scipio Asiaticus Aemilianus | Q7234050 | 200 | 77 | **896** | 28,681 | 255 | yes |
...
| qid | who | wikidata | born | died | **ancestors** | descendants | depth | →Aster |
|---|---|---|---:|---:|---:|---:|---:|:---:|
| `Q73170` | Gaius Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73332` | Publius Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73479` | Quintus Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73599` | Gnaeus Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73710` | Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73812` | Gaius Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73910` | Gaius Servilius | — | — | — | **7** | 19,536 | 0 | no |
| `Q73985` | Quintus Servilius | — | — | — | **7** | 19,536 | 0 | no |
...
| qid | who | wikidata | born | died | **ancestors** | descendants | depth | →Aster |
|---|---|---|---:|---:|---:|---:|---:|:---:|
| `Q85478` | Sekhemre Sankhtawy Neferhotep III | — | — | — | **420** | 31,487 | 207 | yes |
| `Q85500` | Mentuhotep . | — | — | — | **420** | 31,487 | 207 | yes |
| `Q85514` | Senebhenaf . | — | — | — | **420** | 31,487 | 207 | yes |
| `Q85528` | Yauyebi of  Egypt | — | 1790 BC | — | **420** | 31,487 | 207 | yes |
| `Q85554` | Sebekemsaf . | — | — | — | **420** | 31,487 | 207 | yes |
| `Q85578` | Sankhenre Mentuhotep VI | — | — | — | **420** | 31,487 | 207 | yes |

**Decision:** _not made — needs Emma_

---

## 8. Esther  bat Sahlan ben Abraham — 2 records
